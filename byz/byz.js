...
function build(canvas){
    ...
    var byz_top_scene_down_arrow=new Button(canvas.scene("byz_top_scene"),0,0,88,46,51,res.getResource("down_arrow"),null,null,()=>{},()=>canvas.changeScene("byz_door_scene"),416,833);
    ...
    var byz_answer_box_fake_button=new Button(canvas.scene("byz_door_scene"),362,395,180,98,32,null,null,null,()=>{},()=>{
        ...
        byz_answer_box_fake_disable_button.setignoreClickEventt(false);
    });
    ...
    var byz_answer_box_fake_disable_button=new Button(canvas.scene("byz_door_scene"),0,0,935,935,2,null,null,null,()=>{},()=>{
        ...
        byz_answer_box_fake_disable_button.setignoreClickEventt(true);
    });
    byz_answer_box_fake_disable_button.setClickable(false);
    byz_answer_box_fake_disable_button.setignoreClickEventt(true);
    ...
    var byz_top_scene_fake_button=new Button(canvas.scene("byz_top_scene"),167,400,600,81,23,null,null,null,()=>{},()=>{
        ...
        textTransform=setInterval(function(){
            ...
            if(checkAnwser()){
                ...
                byz_top_scene_fake_button.setClickable(false);
                byz_top_scene_anwser_text_blue.setTransparentAlpha(0);
                byz_top_scene_anwser_text_green.setTransparentAlpha(0);
