...
function build(canvas){
    ...
    var wyx_answer_box_fake_button=new Button(canvas.scene("wyx_door_scene"),362,395,180,98,2,null,null,null,()=>{},()=>{
        ...
        wyx_answer_box_fake_disable_button.setIgnoreClickEventtt(false);
    });
    ...
    var wyx_answer_box_fake_disable_button=new Button(canvas.scene("wyx_door_scene"),0,0,935,935,10,null,null,null,()=>{},()=>{
        ...
        wyx_answer_box_fake_disable_button.setIgnoreClickEventtt(true);
    });
    wyx_answer_box_fake_disable_button.setClickable(false);
    wyx_answer_box_fake_disable_button.setIgnoreClickEventtt(true);
    ...
    wyx_right_scene_code_option_left.setIgnoreClickEventtt(true);
    wyx_right_scene_code_option_right.setIgnoreClickEventtt(true);
    wyx_right_scene_code_option_forward.setIgnoreClickEventtt(true);
    wyx_right_scene_code_option_backward.setIgnoreClickEventtt(true);
    ...
    async function chooseOption(ans,x,y){
        ...
        wyx_right_scene_code_option_left.setIgnoreClickEventtt(false);
        wyx_right_scene_code_option_right.setIgnoreClickEventtt(false);
        wyx_right_scene_code_option_forward.setIgnoreClickEventtt(false);
        wyx_right_scene_code_option_backward.setIgnoreClickEventtt(false);
    ...
    for (let i=0;i<11;i++){
        ...
        wyx_right_scene_number_keyboard[i].setIgnoreClickEventtt(true);
    ...
    async function inputNum(ans,x,y){ //输入数字
        ...
        for (let i=0;i<11;i++){
            ...
            wyx_right_scene_number_keyboard[i].setIgnoreClickEventtt(false);
    ...
    wyx_right_scene_turtle.setIgnoreClickEventtt(true);
    ...
    wyx_left_scene_printmaking_final.setIgnoreClickEventtt(true);
